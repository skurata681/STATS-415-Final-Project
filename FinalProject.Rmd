...
colnames(bmx09)[colSums(is.na(bmx09))==0]
colnames(bpx09)[colSums(is.na(bpx09))==0]
colnames(demo09)[colSums(is.na(demo09))==0]
colnames(dr109)[colSums(is.na(dr109))==0]
colnames(smq09)[colSums(is.na(smq09))==0]
colnames(tchol09)[colSums(is.na(tchol09))==0]
#2011
...
cat(nrow(bmx09)+nrow(bmx11)+nrow(bmx13)+nrow(bmx15)+nrow(bmx17))
```
