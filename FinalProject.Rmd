...
data11 = merge(bmx11, bpx11, by = "SEQN")
listy = list(demo11, dr111, smq11, tchol11)
for(i in 1:4){
  data11 = merge(data11, listy[[i]], by = "SEQN")
}
...
data13 = merge(bmx13, bpx13, by = "SEQN")
listy = list(demo13, dr113, smq13, tchol13)
for(i in 1:4){
  data13 = merge(data13, listy[[i]], by = "SEQN")
}
...
data15 = merge(bmx15, bpx15, by = "SEQN")
listy = list(demo15, dr115, smq15, tchol15)
for(i in 1:4){
  data15 = merge(data15, listy[[i]], by = "SEQN")
}
...
data17 = merge(bmx17, bpx17, by = "SEQN")
listy = list(demo17, dr117, smq17, tchol17)
for(i in 1:4){
  data17 = merge(data17, listy[[i]], by = "SEQN")
}
