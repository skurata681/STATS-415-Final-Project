...
library(Hmisc)
library(corrplot)
correlationmatrix = cor(train[,c(which( colnames(train)=="DR1TCAFF" ), which( colnames(train)=="DMDHREDU" ), which( colnames(train)=="INDHHIN2" ), which( colnames(train)=="INDFMIN2" ), which( colnames(train)=="INDFMPIR" ))])
